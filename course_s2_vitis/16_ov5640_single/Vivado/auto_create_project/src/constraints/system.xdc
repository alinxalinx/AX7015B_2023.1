...
connect_debug_port u_ila_0/probe0 [get_nets [list {cmos1_d_IBUF[2]} {cmos1_d_IBUF[3]} {cmos1_d_IBUF[4]} {cmos1_d_IBUF[5]} {cmos1_d_IBUF[6]} {cmos1_d_IBUF[7]} {cmos1_d_IBUF[8]} {cmos1_d_IBUF[9]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe1]
set_property port_width 1 [get_debug_ports u_ila_0/probe1]
connect_debug_port u_ila_0/probe1 [get_nets [list cmos1_href_IBUF]]
create_debug_port u_ila_0 probe
...
connect_debug_port dbg_hub/clk [get_nets cmos1_pclk_IBUF]
