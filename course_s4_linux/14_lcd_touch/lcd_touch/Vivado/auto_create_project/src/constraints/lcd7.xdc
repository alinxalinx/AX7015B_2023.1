set_property PACKAGE_PIN M1 [get_ports {lcd_intr}]
set_property PACKAGE_PIN M2 [get_ports {lcd_bl_pwm}]
set_property PACKAGE_PIN Y13 [get_ports {lcd_i2c_scl_io}]
set_property PACKAGE_PIN Y12 [get_ports {lcd_i2c_sda_io}]
